      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="relative">
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-primary">Stay Connected</h2>
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <a href="#testimonials" className="block text-muted-foreground transition-colors hover:text-primary">
                Testimonials
              </a>
              <a href="#faq" className="block text-muted-foreground transition-colors hover:text-primary">
                FAQ
              </a>
